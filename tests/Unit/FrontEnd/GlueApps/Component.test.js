...
suite('GlueApps.Component', function() {

	const App = GlueApps.App;
	const Component = GlueApps.Component;
	const EventDispatcher = GlueApps.EventDispatcher;

	test('is instance of GlueApps.BaseEntity', function() {
		var component = new Component();
		assert.instanceOf(component, GlueApps.BaseEntity);
	});
